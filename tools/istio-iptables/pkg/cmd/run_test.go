...
func TestRulesWithIpRange(t *testing.T) {
	...
	expected := []string{
		...
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo ! -d 127.0.0.1/32 -p tcp ! --dport 53 -m owner --uid-owner 3 -j ISTIO_IN_REDIRECT",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo -p tcp ! --dport 53 -m owner ! --uid-owner 3 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -m owner --uid-owner 3 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo ! -d 127.0.0.1/32 -p tcp ! --dport 53 -m owner --uid-owner 4 -j ISTIO_IN_REDIRECT",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo -p tcp ! --dport 53 -m owner ! --uid-owner 4 -j RETURN",
		...
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo -p tcp ! --dport 53 -m owner ! --gid-owner 1 -j RETURN",
		...
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo -p tcp ! --dport 53 -m owner ! --gid-owner 2 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -m owner --gid-owner 2 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -p tcp --dport 53 -d 127.0.0.53/32 -j REDIRECT --to-ports 15053",
		...
		"iptables -w -t nat -A OUTPUT -p udp --dport 53 -d 127.0.0.53/32 -j REDIRECT --to-port 15053",
	}
	if !reflect.DeepEqual(actual, expected) {
...
func TestRulesWithTproxy(t *testing.T) {
	...
	expected := []string{
		...
		"iptables -w -t mangle -A ISTIO_TPROXY ! -d 127.0.0.1/32 -p tcp -j TPROXY --tproxy-mark 1337/0xffffffff --on-port 15006",
		...
		"iptables -w -t nat -A OUTPUT -p tcp -j ISTIO_OUTPUT",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo -s 127.0.0.6/32 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo ! -d 127.0.0.1/32 -p tcp ! --dport 53 -m owner --uid-owner 1337 -j ISTIO_IN_REDIRECT",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo -p tcp ! --dport 53 -m owner ! --uid-owner 1337 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -m owner --uid-owner 1337 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo ! -d 127.0.0.1/32 -m owner --gid-owner 1337 -j ISTIO_IN_REDIRECT",
		"iptables -w -t nat -A ISTIO_OUTPUT -o lo -p tcp ! --dport 53 -m owner ! --gid-owner 1337 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -m owner --gid-owner 1337 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -p tcp --dport 53 -d 127.0.0.53/32 -j REDIRECT --to-ports 15053",
		"iptables -w -t nat -A ISTIO_OUTPUT -d 127.0.0.1/32 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -d 1.1.0.0/16 -j RETURN",
		"iptables -w -t nat -A ISTIO_OUTPUT -d 9.9.0.0/16 -j ISTIO_REDIRECT",
		"iptables -w -t nat -A ISTIO_OUTPUT -j RETURN",
		"iptables -w -t nat -A OUTPUT -p udp --dport 53 -m owner --uid-owner 1337 -j RETURN",
		"iptables -w -t nat -A OUTPUT -p udp --dport 53 -m owner --gid-owner 1337 -j RETURN",
		"iptables -w -t nat -A OUTPUT -p udp --dport 53 -d 127.0.0.53/32 -j REDIRECT --to-port 15053",
		"iptables -w -t mangle -A PREROUTING -p tcp -m mark --mark 1337 -j CONNMARK --save-mark",
		"iptables -w -t mangle -A OUTPUT -p tcp -m connmark --mark 1337 -j CONNMARK --restore-mark",
		"iptables -w -t mangle -I ISTIO_INBOUND 1 -p tcp -m mark --mark 1337 -j RETURN",
	}
...
func TestHandleInboundIpv6RulesWithOutboundPorts(t *testing.T) {
	...
	expected := []string{
		...
		"ip6tables -w -t nat -A ISTIO_OUTPUT -m owner --gid-owner 1337 -j RETURN",
		"ip6tables -w -t nat -A ISTIO_OUTPUT -d ::1/128 -j RETURN",
		"ip6tables -w -t nat -A ISTIO_OUTPUT -p tcp --dport 32000 -j ISTIO_REDIRECT",
		"ip6tables -w -t nat -A ISTIO_OUTPUT -p tcp --dport 31000 -j ISTIO_REDIRECT",
	}
	if !reflect.DeepEqual(actual, expected) {
		t.Errorf("Output mismatch.\nExpected: %#v\nActual: %#v", expected, actual)
	}
