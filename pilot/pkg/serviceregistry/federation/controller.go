...
func (c *Controller) getEgressServiceAddrs() ([]*model.Gateway, []string) {
...
func (c *Controller) removeServiceFromStore(service federationmodel.ServiceKey) *model.Service {
	...
	if svc != nil {
		...
		c.xdsUpdater.SvcUpdate(c.clusterID, service.Hostname, svc.Attributes.Namespace, model.EventDelete)
		c.xdsUpdater.EDSCacheUpdate(c.clusterID, service.Hostname, svc.Attributes.Namespace, nil)
	}
	return svc
}
