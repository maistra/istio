...
var knownTypes = map[string]schemaType{
	...
	model.AuthenticationServiceMeshPolicy.Type: {
		schema: model.AuthenticationServiceMeshPolicy,
		object: &ServiceMeshPolicy{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "ServiceMeshPolicy",
				APIVersion: apiVersion(&model.AuthenticationServiceMeshPolicy),
			},
		},
		collection: &ServiceMeshPolicyList{},
	},
	...
	model.ServiceMeshRbacConfig.Type: {
		schema: model.ServiceMeshRbacConfig,
		object: &ServiceMeshRbacConfig{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "ServiceMeshRbacConfig",
				APIVersion: apiVersion(&model.ServiceMeshRbacConfig),
			},
		},
		collection: &ServiceMeshRbacConfigList{},
	},
}
...
// GetItems from a wrapper
func (in *ServiceMeshPolicyList) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
...
// ServiceMeshRbacConfig is the generic Kubernetes API object wrapper
...
// GetSpec from a wrapper
func (in *ServiceMeshRbacConfig) GetSpec() map[string]interface{} {
	return in.Spec
}

// SetSpec for a wrapper
func (in *ServiceMeshRbacConfig) SetSpec(spec map[string]interface{}) {
	in.Spec = spec
}

// GetObjectMeta from a wrapper
func (in *ServiceMeshRbacConfig) GetObjectMeta() meta_v1.ObjectMeta {
	return in.ObjectMeta
}

// SetObjectMeta for a wrapper
func (in *ServiceMeshRbacConfig) SetObjectMeta(metadata meta_v1.ObjectMeta) {
	in.ObjectMeta = metadata
}

// ServiceMeshRbacConfigList is the generic Kubernetes API list wrapper
type ServiceMeshRbacConfigList struct {
	meta_v1.TypeMeta `json:",inline"`
	meta_v1.ListMeta `json:"metadata"`
	Items            []ServiceMeshRbacConfig `json:"items"`
}

// GetItems from a wrapper
func (in *ServiceMeshRbacConfigList) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceMeshRbacConfig) DeepCopyInto(out *ServiceMeshRbacConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceMeshRbacConfig.
func (in *ServiceMeshRbacConfig) DeepCopy() *ServiceMeshRbacConfig {
	if in == nil {
		return nil
	}
	out := new(ServiceMeshRbacConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ServiceMeshRbacConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceMeshRbacConfigList) DeepCopyInto(out *ServiceMeshRbacConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ServiceMeshRbacConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceMeshRbacConfigList.
func (in *ServiceMeshRbacConfigList) DeepCopy() *ServiceMeshRbacConfigList {
	if in == nil {
		return nil
	}
	out := new(ServiceMeshRbacConfigList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ServiceMeshRbacConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
