...
func TestMain(m *testing.M) {
	...
	framework.
		...
		SetupParallel(
			maistra.DeployEchos(&appsPrimary, &appsPrimaryMux, maistra.AppOpts{
				Name:        "a",
				Namespace:   namespace.Future(&ns1),
				ClusterName: "primary",
			}),
			maistra.DeployEchos(&appsPrimary, &appsPrimaryMux, maistra.AppOpts{
				Name:        "b",
			...
			maistra.DeployEchos(&appsPrimary, &appsPrimaryMux, maistra.AppOpts{
				Name:        "d",
				Namespace:   namespace.Future(&ns2),
				ClusterName: "primary",
			}),
			maistra.DeployEchos(&appsSecondary, &appsSecondaryMux, maistra.AppOpts{
				Name:        "c",
				Namespace:   namespace.Future(&ns1),
