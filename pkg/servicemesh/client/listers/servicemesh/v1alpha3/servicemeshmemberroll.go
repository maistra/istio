...
type ServiceMeshMemberRollLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha3.ServiceMeshMemberRoll, err error)
...
// List lists all ServiceMeshMemberRolls in the indexer.
func (s *serviceMeshMemberRollLister) List(selector labels.Selector) (ret []*v1alpha3.ServiceMeshMemberRoll, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha3.ServiceMeshMemberRoll))
	})
	return ret, err
}
...
type ServiceMeshMemberRollNamespaceLister interface {
	...
	Get(name string) (*v1alpha3.ServiceMeshMemberRoll, error)
...
// List lists all ServiceMeshMemberRolls in the indexer for a given namespace.
func (s serviceMeshMemberRollNamespaceLister) List(selector labels.Selector) (ret []*v1alpha3.ServiceMeshMemberRoll, err error) {
...
// Get retrieves the ServiceMeshMemberRoll from the indexer for a given namespace and name.
func (s serviceMeshMemberRollNamespaceLister) Get(name string) (*v1alpha3.ServiceMeshMemberRoll, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha3.Resource("servicemeshmemberroll"), name)
	}
	return obj.(*v1alpha3.ServiceMeshMemberRoll), nil
}
