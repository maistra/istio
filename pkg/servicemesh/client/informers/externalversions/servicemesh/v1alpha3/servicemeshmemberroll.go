...
import (
	...
	servicemeshv1alpha3 "istio.io/istio/pkg/servicemesh/apis/servicemesh/v1alpha3"
	...
	v1alpha3 "istio.io/istio/pkg/servicemesh/client/listers/servicemesh/v1alpha3"
...
type ServiceMeshMemberRollInformer interface {
	...
	Lister() v1alpha3.ServiceMeshMemberRollLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IstioV1alpha3().ServiceMeshMemberRolls(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IstioV1alpha3().ServiceMeshMemberRolls(namespace).Watch(options)
			},
		},
		&servicemeshv1alpha3.ServiceMeshMemberRoll{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceMeshMemberRollInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicemeshv1alpha3.ServiceMeshMemberRoll{}, f.defaultInformer)
}

func (f *serviceMeshMemberRollInformer) Lister() v1alpha3.ServiceMeshMemberRollLister {
	return v1alpha3.NewServiceMeshMemberRollLister(f.Informer().GetIndexer())
}
