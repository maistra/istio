...
func TestCreateResourceName(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedResourceName: "fed-exp-productpage-bookinfo-myveryveryverylongmesh",
		},
		{
			name: "long namespace",
			mesh: "mesh",
			...
			expectedResourceName: "fed-exp-productpage-bigbigbigbigbookinfo-mesh",
		},
		{
			...
			expectedResourceName: "fed-exp-productpage-rest-private-bookinfo-mesh",
		},
		{
			...
			expectedResourceName: "fed-exp-productpage-rest-private-bookinfo-production-teefc2b162",
		},
	}
	for _, tc := range testCases {
		resourceName := createResourceName(tc.mesh.String(), tc.source)
