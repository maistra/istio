...
var (
	logger = log.RegisterScope("federation-exports-controller", "federation-exports-controller", 0)
)
			...
			return cache.NewSharedIndexInformer(
				&cache.ListWatch{
					ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
						return cs.CoreV1alpha1().ServiceExportses(namespace).List(context.TODO(), options)
					},
					WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
						return cs.CoreV1alpha1().ServiceExportses(namespace).Watch(context.TODO(), options)
					},
				},
...
func (c *Controller) reconcile(resourceName string) error {
	...
	instance, err := c.cs.CoreV1alpha1().ServiceExportses(namespace).Get(ctx, name, metav1.GetOptions{})
	if err != nil {
