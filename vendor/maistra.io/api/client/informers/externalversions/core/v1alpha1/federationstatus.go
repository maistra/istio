...
type FederationStatusInformer interface {
	...
	Lister() v1alpha1.FederationStatusLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().FederationStatuses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().FederationStatuses(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha1.FederationStatus{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *federationStatusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha1.FederationStatus{}, f.defaultInformer)
}

func (f *federationStatusInformer) Lister() v1alpha1.FederationStatusLister {
	return v1alpha1.NewFederationStatusLister(f.Informer().GetIndexer())
}
