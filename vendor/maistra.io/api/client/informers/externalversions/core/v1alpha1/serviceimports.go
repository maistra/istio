...
type ServiceImportsInformer interface {
	...
	Lister() v1alpha1.ServiceImportsLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().ServiceImports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().ServiceImports(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha1.ServiceImports{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceImportsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha1.ServiceImports{}, f.defaultInformer)
}

func (f *serviceImportsInformer) Lister() v1alpha1.ServiceImportsLister {
	return v1alpha1.NewServiceImportsLister(f.Informer().GetIndexer())
}
