...
// ServiceExportsLister helps list ServiceExportses.
// All objects returned here must be treated as read-only.
type ServiceExportsLister interface {
	// List lists all ServiceExportses in the indexer.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*v1alpha1.ServiceExports, err error)
	// ServiceExportses returns an object that can list and get ServiceExportses.
	ServiceExportses(namespace string) ServiceExportsNamespaceLister
...
// ServiceExportses returns an object that can list and get ServiceExportses.
func (s *serviceExportsLister) ServiceExportses(namespace string) ServiceExportsNamespaceLister {
	return serviceExportsNamespaceLister{indexer: s.indexer, namespace: namespace}
}

// ServiceExportsNamespaceLister helps list and get ServiceExportses.
// All objects returned here must be treated as read-only.
type ServiceExportsNamespaceLister interface {
	// List lists all ServiceExportses in the indexer for a given namespace.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*v1alpha1.ServiceExports, err error)
