...
// ServiceMeshPeersGetter has a method to return a ServiceMeshPeerInterface.
...
// serviceMeshPeers implements ServiceMeshPeerInterface
type serviceMeshPeers struct {
	client rest.Interface
	ns     string
}

// newServiceMeshPeers returns a ServiceMeshPeers
func newServiceMeshPeers(c *FederationV1Client, namespace string) *serviceMeshPeers {
	return &serviceMeshPeers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *serviceMeshPeers) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ServiceMeshPeer, err error) {
	result = &v1.ServiceMeshPeer{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicemeshpeers").
		Name(name).
...
func (c *serviceMeshPeers) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ServiceMeshPeerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ServiceMeshPeerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicemeshpeers").
...
func (c *serviceMeshPeers) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceMeshPeers) Create(ctx context.Context, serviceMeshPeer *v1.ServiceMeshPeer, opts metav1.CreateOptions) (result *v1.ServiceMeshPeer, err error) {
	result = &v1.ServiceMeshPeer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicemeshpeers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceMeshPeer).
		Do(ctx).
		Into(result)
	return
}
...
func (c *serviceMeshPeers) Update(ctx context.Context, serviceMeshPeer *v1.ServiceMeshPeer, opts metav1.UpdateOptions) (result *v1.ServiceMeshPeer, err error) {
	result = &v1.ServiceMeshPeer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicemeshpeers").
		Name(serviceMeshPeer.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceMeshPeer).
		Do(ctx).
		Into(result)
...
func (c *serviceMeshPeers) UpdateStatus(ctx context.Context, serviceMeshPeer *v1.ServiceMeshPeer, opts metav1.UpdateOptions) (result *v1.ServiceMeshPeer, err error) {
	result = &v1.ServiceMeshPeer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicemeshpeers").
...
func (c *serviceMeshPeers) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *serviceMeshPeers) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceMeshPeers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ServiceMeshPeer, err error) {
	result = &v1.ServiceMeshPeer{}
