...
// ImportedServiceSetsGetter has a method to return a ImportedServiceSetInterface.
...
// importedServiceSets implements ImportedServiceSetInterface
type importedServiceSets struct {
	client rest.Interface
	ns     string
}

// newImportedServiceSets returns a ImportedServiceSets
func newImportedServiceSets(c *FederationV1Client, namespace string) *importedServiceSets {
	return &importedServiceSets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *importedServiceSets) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ImportedServiceSet, err error) {
	result = &v1.ImportedServiceSet{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("importedservicesets").
		Name(name).
...
func (c *importedServiceSets) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ImportedServiceSetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ImportedServiceSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("importedservicesets").
...
func (c *importedServiceSets) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *importedServiceSets) Create(ctx context.Context, importedServiceSet *v1.ImportedServiceSet, opts metav1.CreateOptions) (result *v1.ImportedServiceSet, err error) {
	result = &v1.ImportedServiceSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("importedservicesets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(importedServiceSet).
		Do(ctx).
		Into(result)
	return
}
...
func (c *importedServiceSets) Update(ctx context.Context, importedServiceSet *v1.ImportedServiceSet, opts metav1.UpdateOptions) (result *v1.ImportedServiceSet, err error) {
	result = &v1.ImportedServiceSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("importedservicesets").
		Name(importedServiceSet.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(importedServiceSet).
		Do(ctx).
		Into(result)
...
func (c *importedServiceSets) UpdateStatus(ctx context.Context, importedServiceSet *v1.ImportedServiceSet, opts metav1.UpdateOptions) (result *v1.ImportedServiceSet, err error) {
	result = &v1.ImportedServiceSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("importedservicesets").
...
func (c *importedServiceSets) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *importedServiceSets) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *importedServiceSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ImportedServiceSet, err error) {
	result = &v1.ImportedServiceSet{}
