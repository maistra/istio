...
var serviceexportsResource = schema.GroupVersionResource{Group: "", Version: "v1alpha1", Resource: "serviceexports"}

var serviceexportsKind = schema.GroupVersionKind{Group: "", Version: "v1alpha1", Kind: "ServiceExports"}
