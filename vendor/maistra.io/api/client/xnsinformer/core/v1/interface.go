...
func (v *version) ServiceMeshExtensions() ServiceMeshExtensionInformer {
	return &serviceMeshExtensionInformer{factory: v.factory, namespaces: v.namespaces, tweakListOptions: v.tweakListOptions}
}

// ServiceMeshMembers returns a ServiceMeshMemberInformer.
func (v *version) ServiceMeshMembers() ServiceMeshMemberInformer {
	return &serviceMeshMemberInformer{factory: v.factory, namespaces: v.namespaces, tweakListOptions: v.tweakListOptions}
}

// ServiceMeshMemberRolls returns a ServiceMeshMemberRollInformer.
func (v *version) ServiceMeshMemberRolls() ServiceMeshMemberRollInformer {
	return &serviceMeshMemberRollInformer{factory: v.factory, namespaces: v.namespaces, tweakListOptions: v.tweakListOptions}
}
