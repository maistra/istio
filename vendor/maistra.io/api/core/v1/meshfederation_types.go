...
type MeshFederationSpec struct {
	...
	// XXX: we could consider making this optional for export-only configurations
	...
	// for service discovery.  This address corresponds with the ingress
	// gateway being used for federation on the other mesh.
	// +required
