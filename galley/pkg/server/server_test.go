...
loop:
	for i := 0; ; i++ {
		...
		p.newSource = func(client.Interfaces, []string, time.Duration, controller.MemberRollController, *schema.Instance, *converter.Config) (runtime.Source, error) {
		...
		case 1:
			p.newSource = func(client.Interfaces, []string, time.Duration, controller.MemberRollController,
...
func TestNewServer(t *testing.T) {
	...
	p.newSource = func(_ client.Interfaces, _ []string, _ time.Duration, _ controller.MemberRollController,
		si *schema.Instance, _ *converter.Config) (runtime.Source, error) {
