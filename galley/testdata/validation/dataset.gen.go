...
// dataset/authentication-v1alpha1-ServiceMeshPolicy-invalid.yaml
// dataset/authentication-v1alpha1-ServiceMeshPolicy-valid.yaml
...
// dataset/rbac-v1alpha1-ServiceMeshRbacConfig-invalid.yaml
// dataset/rbac-v1alpha1-ServiceMeshRbacConfig-valid.yaml
...
var _datasetAuthenticationV1alpha1ServicemeshpolicyInvalidYaml = []byte(`apiVersion: authentication.maistra.io/v1
...
func datasetAuthenticationV1alpha1ServicemeshpolicyInvalidYamlBytes() ([]byte, error) {
	return _datasetAuthenticationV1alpha1ServicemeshpolicyInvalidYaml, nil
}

func datasetAuthenticationV1alpha1ServicemeshpolicyInvalidYaml() (*asset, error) {
	bytes, err := datasetAuthenticationV1alpha1ServicemeshpolicyInvalidYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/authentication-v1alpha1-ServiceMeshPolicy-invalid.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _datasetAuthenticationV1alpha1ServicemeshpolicyValidYaml = []byte(`apiVersion: authentication.maistra.io/v1
kind: ServiceMeshPolicy
metadata:
  name: "default"
spec:
...
func datasetAuthenticationV1alpha1ServicemeshpolicyValidYamlBytes() ([]byte, error) {
	return _datasetAuthenticationV1alpha1ServicemeshpolicyValidYaml, nil
}

func datasetAuthenticationV1alpha1ServicemeshpolicyValidYaml() (*asset, error) {
	bytes, err := datasetAuthenticationV1alpha1ServicemeshpolicyValidYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/authentication-v1alpha1-ServiceMeshPolicy-valid.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _datasetRbacV1alpha1ServicemeshrbacconfigInvalidYaml = []byte(`apiVersion: "rbac.maistra.io/v1"
...
func datasetRbacV1alpha1ServicemeshrbacconfigInvalidYamlBytes() ([]byte, error) {
	return _datasetRbacV1alpha1ServicemeshrbacconfigInvalidYaml, nil
}

func datasetRbacV1alpha1ServicemeshrbacconfigInvalidYaml() (*asset, error) {
	bytes, err := datasetRbacV1alpha1ServicemeshrbacconfigInvalidYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/rbac-v1alpha1-ServiceMeshRbacConfig-invalid.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _datasetRbacV1alpha1ServicemeshrbacconfigValidYaml = []byte(`apiVersion: "rbac.maistra.io/v1"
kind: ServiceMeshRbacConfig
metadata:
  name: default
spec:
...
func datasetRbacV1alpha1ServicemeshrbacconfigValidYamlBytes() ([]byte, error) {
	return _datasetRbacV1alpha1ServicemeshrbacconfigValidYaml, nil
}

func datasetRbacV1alpha1ServicemeshrbacconfigValidYaml() (*asset, error) {
	bytes, err := datasetRbacV1alpha1ServicemeshrbacconfigValidYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "dataset/rbac-v1alpha1-ServiceMeshRbacConfig-valid.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"dataset/authentication-v1alpha1-ServiceMeshPolicy-invalid.yaml": datasetAuthenticationV1alpha1ServicemeshpolicyInvalidYaml,
	"dataset/authentication-v1alpha1-ServiceMeshPolicy-valid.yaml":   datasetAuthenticationV1alpha1ServicemeshpolicyValidYaml,
	...
	"dataset/rbac-v1alpha1-ServiceMeshRbacConfig-invalid.yaml":       datasetRbacV1alpha1ServicemeshrbacconfigInvalidYaml,
	"dataset/rbac-v1alpha1-ServiceMeshRbacConfig-valid.yaml":         datasetRbacV1alpha1ServicemeshrbacconfigValidYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"dataset": &bintree{nil, map[string]*bintree{
		...
		"authentication-v1alpha1-ServiceMeshPolicy-invalid.yaml": &bintree{datasetAuthenticationV1alpha1ServicemeshpolicyInvalidYaml, map[string]*bintree{}},
		"authentication-v1alpha1-ServiceMeshPolicy-valid.yaml":   &bintree{datasetAuthenticationV1alpha1ServicemeshpolicyValidYaml, map[string]*bintree{}},
		...
		"rbac-v1alpha1-ServiceMeshRbacConfig-invalid.yaml":       &bintree{datasetRbacV1alpha1ServicemeshrbacconfigInvalidYaml, map[string]*bintree{}},
		"rbac-v1alpha1-ServiceMeshRbacConfig-valid.yaml":         &bintree{datasetRbacV1alpha1ServicemeshrbacconfigValidYaml, map[string]*bintree{}},
